...
class AVL_dictionary:public binaryTree<Value>,public Dictionary<Key,Value>
{
    public:
        AVL_dictionary();
        AVL_dictionary(const AVL_dictionary& tree);
        AVL_dictionary(AVL_dictionary&& tree) noexcept;
        AVL_dictionary(const Pair<Key,Value>* pair_array,unsigned n,bool replace = true);
        AVL_dictionary(const Key* key_array,const Value* value_array,unsigned n,bool replace = true);

        AVL_dictionary& operator = (const AVL_dictionary& tree);
        AVL_dictionary& operator = (AVL_dictionary&& tree) noexcept;
        AVL_dictionary& copy(const Pair<Key,Value>* pair_array,unsigned n,bool replace = true);
        AVL_dictionary& copy(const Key* key_array,const Value* value_array,unsigned n,bool replace = true);
...
//Constructor
template <class Key,class Value>
AVL_dictionary<Key,Value>::AVL_dictionary(){
    root=nullptr;
}
template <class Key,class Value>
AVL_dictionary<Key,Value>::AVL_dictionary(const AVL_dictionary& tree){
...
template <class Key,class Value>
AVL_dictionary<Key,Value>::AVL_dictionary(AVL_dictionary&& tree) noexcept{
    root = tree.root;
    tree.root = nullptr;
}
template <class Key,class Value>
AVL_dictionary<Key,Value>::AVL_dictionary(const Pair<Key,Value>* pair_array,unsigned n,bool replace){
    for(unsigned i = 0;i<n;i++){
        insert(pair_array[i].key(),pair_array[i].value(),replace);
    }
}
template <class Key,class Value>
AVL_dictionary<Key,Value>::AVL_dictionary(const Key* key_array,const Value* value_array,unsigned n,bool replace){
    for(unsigned i=0;i<n;i++){
...
template <class Key,class Value>
void AVL_dictionary<Key,Value>::clear(){
    if(root!=nullptr){
        delete root;
        root = nullptr;
    }
...
//operator = and copy
template <class Key,class Value>
AVL_dictionary<Key,Value>& AVL_dictionary<Key,Value>::operator = (const AVL_dictionary& tree){
    clear();
    root = new AVLNode<Pair<Key,Value>>;
    root->copy(&tree);
    return *this;
...
template <class Key,class Value>
AVL_dictionary<Key,Value>& AVL_dictionary<Key,Value>::operator = (AVL_dictionary&& tree) noexcept{
    clear();
    root = tree.root;
    tree.root = nullptr;
    return *this;
...
template <class Key,class Value>
AVL_dictionary<Key,Value>& AVL_dictionary<Key,Value>::copy(const Pair<Key,Value>* pair_array,unsigned n,bool replace){
    clear();
    for(unsigned i = 0;i<n;i++){
        insert(pair_array[i].key(),pair_array[i].value(),replace);
    }
...
template <class Key,class Value>
AVL_dictionary<Key,Value>& AVL_dictionary<Key,Value>::copy(const Key* key_array,const Value* value_array,unsigned n,bool replace){
    clear();
    for(unsigned i=0;i<n;i++){
        insert(key_array[0],value_array[0],replace);
    }
...
template <class Key,class Value>
bool AVL_dictionary<Key,Value>::empty() const{
    return root==nullptr;
}
template <class Key,class Value>
unsigned AVL_dictionary<Key,Value>::size() const{
...
template <class Key,class Value>
unsigned AVL_dictionary<Key,Value>::depth() const{
    if(root==nullptr) return 0;
    else{
        return root->depth();
    }
...
template <class Key,class Value>
Key AVL_dictionary<Key,Value>::search(const Value& value) const{
...
template <class Key,class Value>
Value& AVL_dictionary<Key,Value>::operator[](const Key& key){
    if(root==nullptr){
        throw illegalParameterValue("Key not found!");
    }else{
...
template <class Key,class Value>
const Value& AVL_dictionary<Key,Value>::operator[](const Key& key) const{
    if(root==nullptr){
        throw illegalParameterValue("Key not found!");
    }else{
...
template <class Key,class Value>
void AVL_dictionary<Key,Value>::preOrder(const std::function<void(Value&)>& visit){
...
template <class Key,class Value>
void AVL_dictionary<Key,Value>::inOrder(const std::function<void(Value&)>& visit){
    if(root==nullptr) return;
    Processed_visit_function<Key,Value> new_visit;
    new_visit.f1 = visit;
...
template <class Key,class Value>
void AVL_dictionary<Key,Value>::postOrder(const std::function<void(Value&)>& visit){
    if(root==nullptr) return;
    Processed_visit_function<Key,Value> new_visit;
    new_visit.f1 = visit;
...
template <class Key,class Value>
void AVL_dictionary<Key,Value>::levelOrder(const std::function<void(Value&)>& visit){
    if(root==nullptr) return;
    Processed_visit_function<Key,Value> new_visit;
    new_visit.f1 = visit;
...
template <class Key,class Value>
void AVL_dictionary<Key,Value>::preOrder(const std::function<void(const Value&)>& visit) const{
    if(root==nullptr) return;
...
template <class Key,class Value>
void AVL_dictionary<Key,Value>::inOrder(const std::function<void(const Value&)>& visit) const{
    if(root==nullptr) return;
    Const_processed_visit_function<Key,Value> new_visit;
    new_visit.f1 = visit;
    root->inOrder(new_visit);
...
template <class Key,class Value>
void AVL_dictionary<Key,Value>::postOrder(const std::function<void(const Value&)>& visit)const{
    if(root==nullptr) return;
    Const_processed_visit_function<Key,Value> new_visit;
    new_visit.f1 = visit;
    root->postOrder(new_visit);
...
template <class Key,class Value>
void AVL_dictionary<Key,Value>::levelOrder(const std::function<void(const Value&)>& visit)const{
    if(root==nullptr) return;
    Const_processed_visit_function<Key,Value> new_visit;
    new_visit.f1 = visit;
    root->postOrder(new_visit);
...
template <class Key,class Value>
bool AVL_dictionary<Key,Value>::insert(const Key& key,const Value& value,bool replace){
    if(root==nullptr){
        root = new AVLNode<Pair<Key,Value>>;
...
template <class Key,class Value>
bool AVL_dictionary<Key,Value>::erase(const Key& key){
    ...
    //Case 1: father1 is null. Then node to delete is the root node;
        ...
        if(left==nullptr&&right==nullptr){
            ...
            left_right->changeRightChild(right);
            left_right_father->changeRightChild(left_right->getLeftChild());
            if((delete_node->get()).key()<(father1->get()).key()) father1->changeLeftChild(left_right);
